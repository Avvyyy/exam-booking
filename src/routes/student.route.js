 ...
 *                   example: {}
 */
studentRoutes.get('/', auth_middleware_1.verifyToken, student_controller_1.getUserDetails);
/**
 * @swagger
 ...
 *                   example: {}
 */
studentRoutes.get('/exam-schedule', auth_middleware_1.verifyToken, student_controller_1.getUserExamSchedules);
/**
 * @swagger
 ...
 *                   example: {}
 */
studentRoutes.get('/slots/:courseId', auth_middleware_1.verifyToken, student_controller_1.getAvailableSlotsForCourse);
/**
 * @swagger
 ...
 *                   example: {}
 */
studentRoutes.get('/batches/:slotId', auth_middleware_1.verifyToken, student_controller_1.getAvailableBatches);
/**
 * @swagger
 * /student/pick-batch:
 *   post:
 ...
 *                   example: {}
 */
studentRoutes.post('/pick-batch', auth_middleware_1.verifyToken, (0, auth_middleware_1.verifyRole)('student'), student_controller_1.pickExamBatch);
