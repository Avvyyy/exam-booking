 ...
 */
adminRoutes.post("/course", auth_middleware_1.verifyToken, (0, auth_middleware_1.verifyRole)("admin"), admin_controller_1.createCourse);
/**
 * @swagger
 * /admin/exam-slot:
 *   post:
 ...
 */
adminRoutes.post("/exam-slot", auth_middleware_1.verifyToken, (0, auth_middleware_1.verifyRole)("admin"), admin_controller_1.createExamSlot);
/**
 * @swagger
 * /admin/{studentId}:
 *   get:
 ...
 */
adminRoutes.get('/:studentId', auth_middleware_1.verifyToken, (0, auth_middleware_1.verifyRole)("admin"), admin_controller_1.getUserDetails);
/**
 * @swagger
 ...
 */
adminRoutes.post("/reschedule-student", auth_middleware_1.verifyToken, (0, auth_middleware_1.verifyRole)("admin"), admin_controller_1.rescheduleStudent);
